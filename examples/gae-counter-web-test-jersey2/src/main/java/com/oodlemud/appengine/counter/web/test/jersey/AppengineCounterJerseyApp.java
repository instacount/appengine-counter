 ...
 */
package com.oodlemud.appengine.counter.web.test.jersey;
...
import com.oodlemud.appengine.counter.web.test.guice.GuiceModule;
...
public class AppengineCounterJerseyApp extends ResourceConfig
{
	...
	public AppengineCounterJerseyApp(ServiceLocator serviceLocator)
	{
		...
		this.property("jersey.config.server.provider.packages",
			"com.fasterxml.jackson.jaxrs.json;com.oodlemud.appengine.counter.web.test.jersey");
