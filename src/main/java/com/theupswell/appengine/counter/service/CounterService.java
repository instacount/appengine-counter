...
/**
 * A Counter Service that can retrieve, increment, decrement, and delete a named {@link
 * com.theupswell.appengine.counter.Counter}.
 *
...
public interface CounterService
{
	 ...
	 * non-negative, so if the underlying implementation does not have a counter with the specified {@code
	 * counterName},
	 ...
	 *                                  being updated. For example, a {@link CounterStatus} of {@code
	 *                                  CounterStatus#DELETING} .
	 ...
	 * @throws IllegalArgumentException if the {@code amount} is negative.
	 * @throws RuntimeException         if the counter exists in the Datastore but has a status that prevents it from
	 *                                  being updated. For example, a {@link CounterData.CounterStatus} of {@code
	 *                                  CounterStatus#DELETING} .
	 * @see {@link CounterService#increment(String, long, boolean)}.
	 */
	 ...
	 *                                   Datastore transaction that is different from the current transactional
	 *                                                  context,
	 *                                   if any. {@code false} if the increment should occur inside of the existing
	 ...
	 * will typically have at least 3 shards, which means decrement operations would likely exceed the limit of 5
	 * entity
	 ...
	 * CounterShardData} entities via a Task Queue. This operation may take some time to complete since it is task
	 * queue
