...
public class CounterShardDecrement extends AbstractCounterShardOperation implements CounterShardOperation
{
	 ...
	 * @param parentCounterOperationUuid A {@link UUID} that identifies the parent operation for this decrement.
	 *            Multiple decrements may occur as part of a single counter operation.
