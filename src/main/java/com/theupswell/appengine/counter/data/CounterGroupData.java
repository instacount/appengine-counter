 ...
 * should be aware that it requires a multi-value index to be able to sort a group of counters by their {@code
 * eventuallyConsistentCount} value.
 *
...
public class CounterGroupData
{
	...
	/**
	 * Create a {@link Key Key<CounterGroupData>}.  This entity only exists in the context of a {@link CounterData},
	 * and
