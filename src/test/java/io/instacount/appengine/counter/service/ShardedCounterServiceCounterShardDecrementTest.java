...
/**
 * Unit tests for decrementing counters via {@link ShardedCounterServiceImpl}.
 * 
 * @author David Fuelling
 */
public class ShardedCounterServiceCounterShardDecrementTest extends AbstractShardedCounterServiceTest
{
	...
	public void testDecrementResult()
	{
		...
		assertThat(result.getCounterOperationType(), CoreMatchers.is(CounterOperationType.DECREMENT));
		assertThat(result.getCounterShardDataKey(), CoreMatchers.is(CounterShardData.key(CounterData.key(TEST_COUNTER1), 2)));
